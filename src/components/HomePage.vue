    ...
    <div class="w-full text-gray-700 relative">
            ...
            <div class="mt-48 w-full md:w-3/4 text-center">
                ...
                <div class="mt-14 text-center md:text-right flex flex-col md:flex-row items-center justify-between">
                    <div class="w-full md:w-1/2 pb-8 md:pr-8">
                        <h2 class="font-wedding text-4xl text-semibold text-gray-800">Khayatul Maisyah </h2>
                        ...
                        <p class="text-sm mt-3 tracking-normal leading-relaxed text-center md:text-right text-gray-700">
                            Putri pertama dari Bapak Sumadi & Ibu Nur Hikmah

                        </p>
                    </div>
                    <div class="w-full md:w-1/2">
                        <div class="w-full relative z-0">
                            <img src="@/assets/aya.jpg" alt="" class="rounded-lg shadow-xl shadow-black-500">
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-14 text-center md:text-left flex flex-col md:flex-row items-center justify-between">
                    ...
                    <div class="w-full md:w-1/2 pb-8 md:pl-8">
                        <h2 class="font-wedding text-4xl text-semibold text-gray-800">Iwan Yuliyansyah
</h2>
                        ...
                        <p class="text-sm mt-3 tracking-normal leading-relaxed text-center md:text-left text-gray-700">
                            Putra ketujuh dari Bapak Adiman & Alm. Ibu Cawiti
        ...
        <div class="text-center p-8 section-3 flex flex-col md:flex-row justify-center">
            <div class="text-white w-full md:w-2/4 p-8 text-center rounded-lg backdrop-blur-sm bg-white/40">
                ...
                <h2 class="font-wedding text-5xl mt-16 tex- wedding">
                    <font-awesome-icon icon="fa-solid fa-ellipsis" />
                    <span class="mx-8">Akad</span> 
                    <font-awesome-icon icon="fa-solid fa-ellipsis" />
                </h2>
                <p>  <span class="font-bold text-1xl">Jam 10.00 Minggu, 7 Mei 2023</span> <br><br> </p>
                <br>
                <h3 class="font-wedding text-5xl mt-16 tex- wedding">
                    <font-awesome-icon icon="fa-solid fa-ellipsis" />
                    <span class="mx-8">Resepsi</span> 
                    <font-awesome-icon icon="fa-solid fa-ellipsis" />
                </h3>
                <p>  <span class="font-bold text-1xl">Jam 13.00 Minggu, 7 Mei 2023</span> <br><br> </p>
                <h4>  <span class="font-bold text-1xl">"Bertempat di Jl. Jumadi Plumbungan, Kec. Kramat,
                    Kabupaten Tegal, Jawa Tengah"</span> <br><br> </h4>
            ...
            <!-- <div class="w-full md:w-2/4">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1534.1675815116455!2d106.86997136200172!3d-6.221837098980891!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f37945c5e99f%3A0x938e2851cfe026c0!2sRptra%20Citra%20Permata!5e0!3m2!1sen!2sid!4v1652105023617!5m2!1sen!2sid"" width="100%" height="100%" style="border:0; min-height: 300px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div> -->
        </div>
                ...
                <div class="mt-14 flex flex-col md:flex-row items-center justify-center text-gray-700">
                    <div class="w-full md:w-2/4">
                        ...
                        <p class="mt-5 leading-relaxed text-justify md:text-right pb-8 md:pr-8">
                            Perkenalan kami dimulai saat kami duduk di bangku SMK,
                            Kebetulan dia teman sekelas saya. <br> <br>
                            Sebelumnya kami hanya saling mengenal saja tidak pernah bertegur sapa dan berkomunikasi satu sama lain.
                            Di tahun 2018 akhirnya kami mulai berkomunikasi dengan malu malu. <br> <br>
                            Tanggal 04 February 2021 pertemuan pertama kami di Bandara Soekarno Hatta,
                            kebetulan saat itu dia baru pulang dari jepang dan saya ada di jakarta. <br> <br>
                            Komunikasi kami semakin intens dan hubungan kami semakin dekat.
                            kami bertemu menyampaikan tujuan masing-masing untuk kehidupan kedepannya,
                            dan kami pun sepakat untuk membawa hubungan ini ke jenjang yang lebih serius.
                        </p>
                    </div>
                    <div class="w-full md:w-2/4">
                        <img src="@/assets/aya-iwan1.jpg" class="w-full rounded-lg shadow-lg shadow-black-500">
                    </div>
                </div>
            </div>
            ...
            <div class="w-full md:w-3/4 mt-16">
                <div class="mt-14 flex flex-col md:flex-row items-center justify-center">
                    <div class="w-full md:w-2/4 hidden md:block">
                        <img src="@/assets/aya-iwan2.jpg" class="w-full rounded-lg shadow-lg shadow-black-500">
                    </div>
                    <div class="w-full md:w-2/4 text-gray-700">
                        ...
                        <p class="mt-5 leading-relaxed text-justify md:text-left pb-8 md:pl-8">
                            21 Maret 2021 kami melangsungkan khitbah dan sampai akhirnya
                            kami memutuskan menikah pada tanggal 07 Mei 2023 <br> <br>
                        </p>
                    </div>
                ...
                <div class="mt-14 flex justify-center">
                    <div class="w-full text-gray-700">
                        ...
                        <p class="mt-5 leading-relaxed text-justify md:text-center pb-8 md:pl-8">
                            ...
                            Tetapi ini sangat spesial untuk kami, Sangat bersyukur
                            di pertemukan Allah diwaktu terbaik, kini kami menanti hari istimewa kami^^"
                        </p>
                    </div>
                </div>
            </div>
                            ...
                            <Transition name="fade-quick">
                                <div v-if="isRizky" key="1" class="w-full flex flex-col md:flex-row justify-between items-center mt-6">
                                    <div class="w-full md:w-1/2 mb-5 md:mb-0">
                                        <img src="@/assets/aya.jpg" class="w-full rounded-lg">
                                    </div>
                                ...
                                <div v-else key="2" class="w-full flex flex-col md:flex-row justify-between items-center mt-6">
                                    ...
                                    <div class="w-full md:w-1/2">
                                        ...
                                        <p class="text-sm">a/n Khayatul Maisyah</p>
                                    </div>
                                </div>
                            </Transition>
                        </div>
        ...
        <div class="text-center bg-white-800 p-8 flex flex-col items-center justify-center">
            <p class="text-white-400 mb-5">2023 &copy; Built and Designed by Jagur's <span class="text-pink-500"><font-awesome-icon icon="fa-solid fa-heart" /></span></p>
            <hr class="w-full border-1 border-gray-300">

            <h1 class="text-gray-600 mt-5">Lokasi Resepsi</h1>
            <br> "Bertempat Jl. Jumadi
                Plumbungan, Kec. Kramat, Kabupaten Tegal, Jawa Tengah"
                <br> 
<iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d1980.5060641148439!2d109.2196029!3d-6.88915!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e6fc7a365f0409b%3A0x423a108933415c96!2sJl.%20Jumadi%2C%20Kec.%20Kramat%2C%20Kabupaten%20Tegal%2C%20Jawa%20Tengah%2052181!5e0!3m2!1sen!2sid!4v1682878200342!5m2!1sen!2sid" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
...
export default {
    ...
    methods: {
        getCountdown() {
            ...
            var countDownDate = new Date("May 7, 2023 10:00:00").getTime();
        ...
        openInvitation() {
            this.opened = true
            this.audio.src = require("../assets/payung teduh.mp3")
...
<style scoped>
    ...
    .section-3 {
        background: url('@/assets/foto-2.jpg') no-repeat right center;
        background-size: cover;
    }

    .section-footer {
        background: url('@/assets/footbanner.jpg') no-repeat left center;
        background-size: cover;
    }

    .bg-wedding {
        background: url('@/assets/mainbanner.jpg') no-repeat center;
        background-size: cover;
        height: 30rem;
    }
